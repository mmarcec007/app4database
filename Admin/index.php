		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<form class="form-horizontal" action="post_handler.php?mode=login" method="post" >
						<fieldset>
					...
					<hr>
					<h3>Zaboravili ste lozimnku?</h3>
					<p>
						Nema problema, <a href="#">kliknite ovdje</a> da se vam promjeni lozinka.
					</p>	
				</div><!--/span-->
			</div><!--/row-->
